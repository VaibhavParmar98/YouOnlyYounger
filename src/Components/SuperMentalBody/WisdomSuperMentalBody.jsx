          ...
          <div className="py-10 lg:py-20 xl:mt-40 lg:mt-20 mt-20">
            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-6 px-4 font-inter">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-4 ">
                ...
                <Text variant='text1' className=" flex items-center gap-3  text-gray-700">When you access this higher layer of consciousness:</Text>
                <Text variant='text1' className=" flex items-center gap-3  text-gray-700">
