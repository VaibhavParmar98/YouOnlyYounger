...
const ContactSection = () => {
  return (
    <section className="bg-purple-50 py-16 px-4 font-inter">
          <h2 className="text-3xl font-semibold text-center mb-6 font-marcellous">Let’s Talk</h2>
        ...
        <div className="md:w-1/2 w-full space-y-4">
          ...
          <form className="space-y-4">
           ...
           <div className="flex justify-between">
             <button
              type="submit"
              className="p-3 w-44 bg-[#400186] text-white rounded-full transition"
            >
              Submit
            </button>
             <div className="flex items-center gap-3 mt-6">
            <div className="bg-purple-200 text-[#400186] p-2 rounded-full">
              <Mail size={18} />
            </div>
            <div>
              <p className="text-sm font-medium">Email</p>
              <p className="text-sm text-gray-700">Info@YouOnlyYounger.com</p>
            </div>
          </div>
           </div>
          </form>
