        ...
        <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6 p-3 relative">
          ...
          <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1 relative">
            ...
            <img
              src="./31.png"
              alt=""
              className="absolute w-28 h-28 xl:w-56 xl:h-56 -left-5 2xl:-left-60 2xl:-top-20 xl:-left-50 xl:-top-20 lg:-left-0 lg:top-72 md:-left-0 md:-top-44 mt-44 md:mt-64 z-0"
            />
          </div>
