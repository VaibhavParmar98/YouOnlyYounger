  ...
  return (
    <div className="bg-[#F6F6F6] py-10 px-4 sm:px-6 md:px-8">
      ...
      <div className="flex flex-col gap-3 text-center mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-marcellous">
          Before & After Gallery
        </h1>
        <p className="text-sm sm:text-base md:text-lg max-w-4xl mx-auto leading-relaxed font-inter">
