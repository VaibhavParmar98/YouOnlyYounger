...
const RestorativeApproach = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 font-inter">
      ...
      {/* Grid Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-cente">
        {/* Card 1 */}
        <div className="bg-[#EFECFD] p-5 rounded-lg flex flex-col gap-3">
        ...
        {/* Card 2 */}
        <div className="bg-[#FFF2E0] p-5 rounded-lg flex flex-col gap-3">
        ...
        {/* Card 3 */}
        <div className="bg-[#F0F8FF] p-5 rounded-lg flex flex-col gap-3">
        ...
        {/* Card 4 */}
        <div className="bg-[#EAF7F2] p-5 rounded-lg flex flex-col gap-3">
        ...
        {/* Card 5 */}
        <div className="bg-[#FEE4D9] p-5 rounded-lg flex flex-col gap-3">
