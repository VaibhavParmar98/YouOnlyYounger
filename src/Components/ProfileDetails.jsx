...
const ProfileDetails = () => {
  return (
    <div className="bg-[#F6F6F6] py-10">
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-6 px-4 font-inter">
        {/* Image Section */}
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#400186] font-marcellous">
          ...
          <button className="w-fit px-6 py-2 text-white bg-[#400186] rounded-full hover:bg-[#310066] transition">
            About me
          </button>
        </div>
      </div>
