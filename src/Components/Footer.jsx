...
const Footer = () => {
  return (
    <div className="bg-[#400186] text-white font-inter">
      <footer className="py-10 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        {/* Top section */}
          ...
          <div className="lg:w-1/2 flex flex-col gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-10">
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-xl sm:text-2xl font-semibold font-marcellous">Let’s Chat</h3>
              ...
              <div className="flex flex-col gap-1 text-sm sm:text-base">
                <h3 className="text-xl sm:text-2xl font-semibold font-marcellous">Clinic Hours</h3>
            ...
            <div className="flex flex-col gap-3">
              <h3 className="text-xl sm:text-2xl font-semibold font-marcellous">URLs</h3>
