      ...
      <div className="max-w-7xl mx-auto bg-[#400186] rounded-2xl p-6">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="lg:flex-row text-center lg:text-left flex flex-col  items-center gap-6">
           ...
           <Text variant="text5" className="font-bold text-[#400186]">01</Text>{" "}
          ...
          <div className="flex flex-col gap-3 bg-white rounded-2xl p-3">
<Text variant="text5" className="font-bold text-[#400186]">02</Text>            <Text variant="text3" className="font-semibold ">IV Nutrient Therapy</Text>{" "}
            <Text variant="text1">
          ...
          <div className="flex flex-col gap-3 bg-white rounded-2xl p-3">
<Text variant="text5" className="font-bold text-[#400186]">03</Text>            <Text variant="text3" className="font-semibold ">
